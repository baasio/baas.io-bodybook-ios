...
-(id)initWithArrayOfVC:(NSArray *)array{
    ...
    if (self){
        ...
        self.menuVC.view.frame = CGRectMake(0, 0, 161.5, [[UIScreen mainScreen] bounds].size.height - 20);
        //self.menuVC.view.frame = CGRectMake(0, 0, 161.5, 548);
        ...
        [self.menuVC.view setFrame:CGRectMake(0, 20, 120, [[UIScreen mainScreen] bounds].size.height - 20)];
...
- (void)viewDidLoad
{
    [self changeMain:[[viewsArray objectAtIndex:1] objectForKey:@"vc"]];
    current = 1;
    [super viewDidLoad];
...
-(void)changeMain:(UIViewController *)main{
    ...
    self.mainVC.view.frame = CGRectMake(0, 0, 320, [[UIScreen mainScreen] bounds].size.height - 20);
...
-(void)open{
    if (!menuOpened){
        self.menuVC.view.frame = CGRectMake(0, 0, 161.5, [[UIScreen mainScreen] bounds].size.height);
